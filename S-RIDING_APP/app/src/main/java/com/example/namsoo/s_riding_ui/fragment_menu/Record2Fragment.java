...
public class Record2Fragment extends Activity {
...
//                    85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f, 85f}};
    ...
    public void onCreate(Bundle savedInstanceState, PersistableBundle persistentState) {
        ...
        dbManager = new DBManager(getApplicationContext(), "TESTGRAPH.db", null, 1);
        LineChart2Layout = (LinearLayout) findViewById(R.id.lineChart2Layout);
...
//
//
//        Tooltip tip = new Tooltip(getApplicationContext(), R.layout.barchart_three_tooltip);
//
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
